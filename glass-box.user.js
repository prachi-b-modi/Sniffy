// ==UserScript==
// @name         Apple-Style Glass Draggable Box
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Adds a sleek glass-looking draggable box to any webpage
// @author       You
// @match        *://*/*
// @grant        none
// @run-at       document-end
...
(function() {
    ...
    // Function to expose to the webpage
    function addGlassBox(text) {
        return createGlassBox(text);
    }
    
    // Expose the function to the global scope
    window.addGlassBox = addGlassBox;
    
    // Create a default glass box on script load (uncomment to automatically show on page load)
    // createGlassBox();
})();
