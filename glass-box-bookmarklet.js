// This is the bookmarklet version of the glass box script
// To use it, create a new bookmark in your browser and paste this entire script as the URL
...
javascript:(function() {
    ...
    const userInput = prompt('Enter text for your glass box (use new lines for bullet points):', 'Welcome to your glass box\nAdd multiple lines\nEach becomes a bullet point');
    
    // Create the glass box if user provided input
    if (userInput) {
        createGlassBox(userInput);
    }
})();
